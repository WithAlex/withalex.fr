  ...
  <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
    <div id="profile" class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white mx-6 lg:mx-0">
      <div class="p-4 md:p-12 text-center lg:text-left">
        ...
        <div class="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center" style="background-image: url('https://res.cloudinary.com/dxttfb2j5/image/upload/f_auto,q_auto/v1651411132/PSX_20220501_151609_rshd5t.jpg')"></div>

        <h1 class="text-3xl font-bold pt-8 lg:pt-0">LESAGE Alexandre</h1>
        ...
        </svg> Savoie - 45.4932° N, 6.4724° E</p>

        <div class="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
          <a class="link" href="https://twitter.com/withalex_" target="_blank">
            <svg class="h-6 fill-current text-gray-600 hover:text-green-700" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Twitter</title><path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/></svg>
          </a>
          <a class="link" href="https://github.com/WithAlex" target="_blank">
          ...
          <a class="link" href="https://www.instagram.com/withalex/" target="_blank">
          ...
          <a class="link" href="https://www.linkedin.com/in/alexandre-lesage-7766b683/" target="_blank">
    ...
    <div class="w-full lg:w-2/5">
      <img src="https://res.cloudinary.com/dxttfb2j5/image/upload/f_auto,q_auto/v1651411132/PSX_20220501_151609_rshd5t.jpg" class="rounded-none lg:rounded-lg shadow-2xl hidden lg:block" alt="Moi">
    </div>
  </div>
</template>
