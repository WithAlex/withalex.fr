    ...
    <div id="profile" class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
      <div class="p-4 md:p-12 text-center lg:text-left">
        ...
        <div class="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
          <a class="link" href="https://twitter.com/withalex_" target="_blank" v-html="twitterIcon"></a>
          <a class="link" href="https://github.com/WithAlex" target="_blank" v-html="githubIcon"></a>
          <a class="link" href="https://www.instagram.com/withalex/" target="_blank" v-html="instagramIcon"></a>
          <a class="link" href="https://www.linkedin.com/in/alexandre-lesage-7766b683/" target="_blank" v-html="linkedinIcon"></a>
        </div>
